...
Split-entry oscillation/volatility strategy on BTC-correlated markets. Monitors BTC price movements and executes automated strategies on prediction markets.

## Architecture

- **Backend**: Node.js/TypeScript service with PostgreSQL database
- **Frontend**: Next.js dashboard with real-time WebSocket updates
- **Strategy**: Split-entry oscillation/volatility strategy on BTC-correlated markets
